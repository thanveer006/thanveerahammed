        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {projects.map((project, i) => (
            <Reveal key={project.slug} delay={(i % 2) * 0.08}>
              ...
              >
                <div
                  className="mb-6 flex h-32 items-center justify-center rounded-lg border border-border/60 bg-secondary/50 bg-[linear-gradient(135deg,transparent_calc(50%-1px),var(--color-border)_50%,transparent_calc(50%+1px))] bg-[length:16px_16px]"
                  aria-hidden
                >
